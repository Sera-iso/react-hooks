...
useEffect also allows you to add dependencies in order to update the state only if the value of the mentioned dependency changes. If the dependency array is left empty, the useEffect will only run once.
